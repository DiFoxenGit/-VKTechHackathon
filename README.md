...
[![Тесты](https://img.shields.io/badge/Тесты-29%20сценариев-520978)](#-тесты)
...
flowchart LR
    ...
    G --> L
    L --> A[Аудит<br/>22 правила + проверка модели]
...
| **Интерфейс** | `frontend/src/services/` | типизированный клиент API и слой сопоставления с экранами |
...
```bash
cd backend && pytest -q      # 29 сценариев: парсинг, вёрстка, аудит, фиксы, экспорт, API
...
frontend/
  src/services/     клиент API и сопоставление с UI
  src/App.tsx       экраны
  src/engine.ts     локальный предпросмотр и демо-режим
