...
export type AuditIssue = { id: string; slideId: string; severity: 'warning' | 'error'; title: string; description: string; fixable: boolean; rule: string; /** У находки есть рамка: её можно обвести на превью. */ boxed: boolean };
