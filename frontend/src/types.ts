...
export type Deck = { id: string; title: string; slides: Slide[]; templateId: string; layout: Layout; updatedAt: string; brief?: Brief; /** Ревизия на сервере: по ней кешируются миниатюры. */ revision?: number };
